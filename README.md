...
2. 데이터 및 시각화 결과
   ...
   3) 정제 과정
      ...
      - 교통량: PDF 파일 23p 구 단위 내부 통행량 부분을 엑셀파일로 기입 후 csv 파일로 변환
...
<img width="2369" height="858" alt="image" src="https://github.com/user-attachments/assets/88c4f791-2747-4b2c-84bb-6aeb0817acba" />
  교통량 상위 및 환승 구간에 해당하는 지역일 수록 이동 경로 주의 및 인파의 영향으로 분실물이 발생하기 쉬울 것이라 예상되어, 습득물 수가 높은 회사를 순위형 그래프로 나타내고, 비교를 위해 구내 교통량을 표로 제시했다. 구내 교통량은 강남구, 관악구, 송파구, 강서구, 은평구 순이다. 총 교통량 5위인 은평구가 습득물 수 4위에 있으나, 이 정보만으로는 두 요소간 상관관계를 유의미하게 확인하기 어렵다. 외부로부터 오는 버스 이동량 및 환승구간 데이터로 보완할 필요가 있다.
